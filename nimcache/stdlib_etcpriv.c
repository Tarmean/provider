...
/* Command for C compiler:
   gcc -c  -w  -I/usr/lib/nim -o /home/cyril/Projects/provider/nimcache/stdlib_etcpriv.o /home/cyril/Projects/provider/nimcache/stdlib_etcpriv.c */
...
static N_INLINE(NIM_BOOL, ismagicidentseparatorrune_158006)(NCSTRING cs, NI i) {
	...
	if (!(LOC2)) goto LA3;
	nimln(22, "etcpriv.nim");
	TMP669 = addInt(i, ((NI) 1));
	LOC2 = ((NU8)(cs[(NI)(TMP669)]) == (NU8)(128));
	LA3: ;
	LOC1 = LOC2;
	if (!(LOC1)) goto LA4;
	nimln(23, "etcpriv.nim");
	TMP670 = addInt(i, ((NI) 2));
	LOC1 = ((NU8)(cs[(NI)(TMP670)]) == (NU8)(147));
	LA4: ;
	result = LOC1;
	popFrame();
	return result;
